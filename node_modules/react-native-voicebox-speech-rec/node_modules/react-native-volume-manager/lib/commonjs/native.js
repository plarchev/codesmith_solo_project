...
exports.removeRingerListener = exports.isRingerListenerEnabled = void 0;
 ...
 * @returns {Promise<void>} - Resolves when the operation has finished
 */
async function enableInSilenceMode() {
  let enabled = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  if (isAndroid) {
    return undefined;
  }
 ...
 */
exports.isRingerListenerEnabled = isRingerListenerEnabled;
