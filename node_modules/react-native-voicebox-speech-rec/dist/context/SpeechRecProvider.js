...
export const SpeechRecContext = React.createContext({
 ...
 */
export const SpeechRecProvider = ({ children, }) => {
    ...
    const unregisterListener = useCallback(({ type, listener }) => {
        setListeners(currentListeners => ({
            ...currentListeners,
    ...
    return (<SpeechRecContext.Provider value={contextValue}>
      {children}
